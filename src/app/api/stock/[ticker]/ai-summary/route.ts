...
반드시 JSON으로만 응답하세요:
{
  ...
  "mainProducts": "주요 제품/상품/서비스 목록. 예: 1) HBM 메모리 반도체 2) DRAM 3) NAND Flash. 구체적 제품명과 용도를 3-5개 나열",
  "businessModel": "어떤 제품/서비스로 돈을 버는지 2-3문장. 매출 비중(예: 반도체 55%, 모바일 25%), 주력 제품, 주요 고객/시장을 구체적으로",
